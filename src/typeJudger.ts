...
export { isFalse } from './code_1/isFalse'

export { isNumber } from './code_1/isNumber'
export { isInfinity } from './code_1/isInfinity'
export { isFinite } from './code_1/isFinite'
export { isNaN } from './code_1/isNaN'
export { isInt } from './code_1/isInt'

export { isString } from './code_1/isString'
